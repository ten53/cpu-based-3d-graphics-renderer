...
bool initialize_window(void) {
    ...
    // set width and height of SDL window with max screen resolution
    SDL_DisplayMode display_mode;
    SDL_GetCurrentDisplayMode(0, &display_mode);
    int fullscreen_width = display_mode.w;
    int fullscreen_height = display_mode.h;

    // simulate low res by scaling down
    // int factor = 3;
    // window_width = fullscreen_width / factor;
    // window_height = fullscreen_height / factor;
